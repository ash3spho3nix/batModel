function E_oc=open_circuit_voltage_LA12_T(a,b,x,C,N,Vend,T)
...
E_oc = (Vend+a(9)-((a(1).*x-a(2).*(x.^2)+(1*a(3)).*(x.^3)-1*a(4).*(x.^4)...
    +1*a(5).*(x.^5)-1*a(6).*(x.^6)+1*a(7).*(x.^7)).*(1+0.01*a(8)*C+0.001*a(30)*(C^2)+0.0001*a(29)*C^3)...
    .*(0.01*b(:,13)*((T/25)-1)+0.01*b(:,14)*((T/25)-1).^2+0.001*b(:,15)*((T/25)-1).^3+0.001*b(:,16)*((T/25)-1).^4+1)))*N;
