function s=one_cycle_kokam_GA_T(a,b,C,Cend,Vend,Temp)
[r c]=size(b);
I=53*C;
T=Temp;
tt=2000;
...
[V11 Rin Rin_2 Cin_2]=V_el_T(a,b,0,C,V_1,1,I,deltaT,T);
s.Rin=Rin;s.Rin_2=Rin_2;s.Cin_2=Cin_2;
V_1(:,1)=V11;
Co=Cend/0.99;
PeuCap = ((Capacity/2)^k)*2; % See equation 2.12
% Starting voltage set outside loop
V(:,1) = open_circuit_voltage_LA12_T(a,b,0,C,NoCells,Vend,T) - V_1(:,1); % Equ 2.1
for n=2:tt
    ...
    [V11 Rin Rin_2 Cin_2]=V_el_T(a,b,DoD(:,n),C,V_1,n,I,deltaT,T);
    V_1(:,n)=V11;
    V(:,n)=open_circuit_voltage_LA12_T(a,b,DoD(:,n),C,NoCells,Vend,T)-V_1(:,n);
